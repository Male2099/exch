			...
			<div class="card-body">
				...
				<div class="mb-3">
					...
					<div class="mb-3">
						...
						<div class="card">
							<input id="totalSpend" type="text" name="totalSpend" class="form-control"
								placeholder="Total Spend" required v-model="customers.totalSpend">
						</div>
					</div>
					<div class="mb-3">
						<label for="lastOrderAt" class="form-label">Last Order At</label>
						<div class="card">
							<input id="lastOrderAt" type="text" name="lastOrderAt" class="form-control"
								placeholder="Last Order At" required v-model="customers.lastOrderAt">
						</div>
					</div>
					<div class="mb-3">
						<label for="totalOrders" class="form-label">Total Order</label>
						<div class="card">
							<input id="totalOrders" type="text" name="totalOrders" class="form-control"
								placeholder="total Orders" required v-model="customers.totalOrders">
						</div>
					</div>
				</div>
				<div>
