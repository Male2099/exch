...
export default {
	...
	async mounted() {
		...
		this.categories = categoryPage.data;
					...
					<div class="card">
						<div class="card">
							<input id="productCode" type="text" name="productCode" class="form-control"
								placeholder="Product Code" required v-model="products.productCode">
						</div>
					</div>
				</div>
				<div class="mb-3">
					...
					<div class="card">
						<div class="card">
							<input id="quantity" type="text" name="quantity" class="form-control" placeholder="Quantity"
								required v-model="products.quantity">
						</div>
					</div>
				</div>
					...
					<div class="card">
						<div class="card">
							<input id="description" type="text" name="description" class="form-control"
								placeholder="Description" required v-model="products.description">
						</div>
					</div>
				</div>
				<div class="mb-3">
