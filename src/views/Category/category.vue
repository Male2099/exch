      ...
      columns: [
        ...
        },
        {
          ...
          display: function (row) {
            return (
              `<div>
                <a href="/category/view" type="button" data-id="' + row.id + '" class="btn btn-success btn-rounded px-4 rounded-pill">View</a>
...
<template>
	<div class="d-flex align-items-center mb-3">
		...
		<div class="ms-auto">
			<a href="/category/add" class="btn btn-success btn-rounded px-4 rounded-pill" aria-expanded="false"><i class="fa fa-plus fa-lg me-2 ms-n2 text-success-900"></i>Add</a>
