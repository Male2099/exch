...
<template>
	...
	<DatePickerBetweenVue @filterDate="handleFilterDate" />
						...
						<div class="col-xl-7 col-lg-8">
							...
							<div class="d-flex mb-1">
								...
								<div class="ms-auto mt-n1 mb-n1">
									<apexchart type="line" height="36" :options="sales.chart.options"
										:series="sales.chart.series"></apexchart>
								</div>
							</div>
							<!-- END total-sales -->
							<!-- BEGIN percentage -->
							...
							<div class="row text-truncate">
								...
								<div class="col-6">
									...
									<div class="fs-18px mb-8px fw-bold">$<span data-animation="number"
					...
					<div class="card border-0 text-truncate mb-3 bg-gray-800 text-white">
						...
						<div class="card-body">
							...
							<div class="d-flex align-items-center mb-1">
								...
								<div class="ms-auto">
									<apexchart type="line" height="28" :options="conversion.chart.options"
										:series="conversion.chart.series"></apexchart>
								</div>
							</div>
							<!-- END conversion-rate -->
							<!-- BEGIN percentage -->
					...
					<div class="card border-0 text-truncate mb-3 bg-gray-800 text-white">
						...
						<div class="card-body">
							...
							<div class="d-flex align-items-center mb-1">
								...
								<div class="ms-auto">
									<apexchart type="line" height="28" :options="session.chart.options"
										:series="session.chart.series"></apexchart>
								</div>
							</div>
							<!-- END store-session -->
							<!-- BEGIN percentage -->
		...
		<div class="col-xl-8 col-lg-6">
			<div class="card border-0 mb-3 bg-gray-800 text-white">
				...
				<div class="card-body pe-3 ps-0 py-0">
					<apexchart type="bar" width="100%" height="252" :options="visitor.chart.options"
						:series="visitor.chart.series"></apexchart>
				</div>
			</div>
		</div>
